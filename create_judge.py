...
def create_judge():
    ...
    Respond with a JSON object of four items of one sentence each. The JSON object should contain four entries, FORM, RHYME, METER and CONTENT.
    ...
    Respond only with this JSON object, and do not use the word CONTEXT in your response.
    """
